...
//                     splashColor: NutritionPalette.purple.withValues(
//                       alpha: 0.12,
//                     ),
//                     highlightColor: NutritionPalette.purple.withValues(
//                       alpha: 0.06,
//                     ),
//                     child: Center(
//                       child: Row(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            if (nutrition.hasUnknownIngredients)
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        '${nutrition.unknownIngredientCount} ingredient${nutrition.unknownIngredientCount > 1 ? 's' : ''} could not be recognized. Nutrition data may be incomplete.',
                        style: TextStyle(
                          fontSize: 12,
