...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  ...
  String? get _displayDescription =>
      _localized?.description ?? recipe.description;
  ...
  String? get _displayCategory => _localized?.category ?? recipe.category;
  String? get _displayCuisine => _localized?.cuisine ?? recipe.cuisine;
                    ...
                    Row(
                      children: [
                        _shareInfoItem(
                          ...
                          title: 'Servings',
                          value:
                              '${_displayServings ?? recipe.servings ?? '-'}',
                        ),
                        const SizedBox(width: 24),
                        _shareInfoItem(
                          icon: Icons.access_time,
                      ...
                      onTap: checkedCount == 0
                          ...
                          : () {
                              ...
                              final groceryController =
                                  Get.find<GroceryStore>();
                              final toAdd = <String>[];
                              // Uses the CANONICAL (English) list here, not the
                              // translated display list, so grocery items are
                              // stored the same way regardless of who added
                              // them — indices line up 1:1 with the display
                              // list since translation preserves order.
                              for (
                                var i = 0;
                                i < recipe.ingredients.length;
                                i++
