...
class _RecipeDetailScreenState extends State<RecipeDetailScreen> {
  ...
  void initState() {
    super.initState();
    AnalyticsService.instance.trackScreen('RecipeDetailScreen');
                    ...
                    child: GestureDetector(
                      onTap: checkedCount == 0
                          ...
                          : () {
                              ...
                              AnalyticsService.instance.trackButtonTap(
                                "$checkedCount Item Add to Groceries",
                                screenName: "_showGrocerySelectionSheet",
                              );
                            },
                      child: Container(
                        height: 50,
...
class _MealPlanPickerSheetState extends State<_MealPlanPickerSheet> {
  ...
  Future<void> _confirm() async {
    ...
    try {
      ...
      AnalyticsService.instance.trackButtonTap(
        "Add to $_mealTypeKeys -Meal plan",
        screenName: "MealPlanPickerSheet",
      );
    } catch (_) {
      if (mounted) {
        setState(() {
...
class _CookbookPickerSheetState extends State<CookbookPickerSheet> {
  ...
  Future<void> _apply() async {
    ...
    for (final id in toAdd) {
      ...
      AnalyticsService.instance.trackButtonTap(
        "Recipe Add To Cookbook",
        screenName: "CookbookPickerSheet",
      );
    }
