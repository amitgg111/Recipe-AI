...
class SortSheet extends StatefulWidget {
  ...
  const SortSheet({super.key, this.selectedIndex = 0});

  static Future<int?> show(BuildContext context, {int selectedIndex = 0}) {
    return showModalBottomSheet<int>(
      context: context,
      backgroundColor: Colors.transparent,
      isScrollControlled: true,
      builder: (_) => SortSheet(selectedIndex: selectedIndex),
    );
  }
...
class _SortSheetState extends State<SortSheet> {
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              children: [
                _SortOption(
                  icon: _buildClockIcon(isSelected: _selectedIndex == 0),
                  title: 'newest_first'.tr,
                  isSelected: _selectedIndex == 0,
                  onTap: () => _select(0),
                ),
                ...
                _SortOption(
                  icon: _buildClockIcon(isSelected: _selectedIndex == 1),
                  title: 'oldest_first'.tr,
                  isSelected: _selectedIndex == 1,
                  onTap: () => _select(1),
                ),
  ...
  void _select(int index) {
    ...
    // Immediately return selected sorting type.
